export const collectedFingerprints = {
...
/*
'nftmall.io': [ 'I', ' ', 'would', ' ', 'like', ' ', 'to', ' ', 'update', ' ', 'preferences.', '\n', '{', '\n  ', '"name":', ' ', '"",', '\n  ', '"username":', ' ', '"test372",', '\n  ', '"bio":', ' ', 'null,', '\n  ', '"email":', ' ', '"test@gmail.com",', '\n  ', '"links":', ' ', '{', '\n    ', '"WEB_SITE":', ' ', '"",', '\n    ', '"TWITTER":', ' ', '"",', '\n    ', '"TELEGRAM":', ' ', '"",', '\n    ', '"DISCORD":', ' ', '"",', '\n    ', '"YOUTUBE":', ' ', '"",', '\n    ', '"INSTAGRAM":', ' ', '"",', '\n    ', '"TIKTOK":', ' ', '"",', '\n    ', '"TWITCH":', ' ', '"",', '\n    ', '"SNAPCHAT":', ' ', '""', '\n  ', '}', '\n', '}' ],
*/
...
'campfire.exchange': [ 'campfire.exchange', ' ', 'wants', ' ', 'you', ' ', 'to', ' ', 'sign', ' ', 'in', ' ', 'with', ' ', 'your', ' ', 'Ethereum', ' ', 'account:', '\n', '_address_', '\n\n', 'Welcome', ' ', 'to', ' ', 'Campfire!', ' ', 'Click', ' ', 'to', ' ', 'sign', ' ', 'in,', ' ', 'this', ' ', 'request', ' ', 'will', ' ', 'not', ' ', 'trigger', ' ', 'a', ' ', 'blockchain', ' ', 'transaction', ' ', 'or', ' ', 'cost', ' ', 'any', ' ', 'gas', ' ', 'fees.', ' ', 'Your', ' ', 'authentication', ' ', 'status', ' ', 'will', ' ', 'reset', ' ', 'after', ' ', '24hrs.', '\n\n', 'URI:', ' ', 'https://campfire.exchange', '\n', 'Version:', ' ', '1', '\n', 'Chain', ' ', 'ID:', ' ', '1', '\n', 'Nonce:', ' ', '_nonce_', '\n', 'Issued', ' ', 'At:', ' ', '2023-05-19T08:14:10.549Z' ],

'liquidifty.io': [ 'Welcome', ' ', 'to', ' ', 'Lifty!', '\n\n', 'Please', ' ', 'click', ' ', 'here', ' ', 'to', ' ', 'accept', ' ', 'and', ' ', 'sign', ' ', 'the', ' ', 'Lifty', ' ', 'Terms', ' ', 'of', ' ', 'Service:', ' ', 'https://docs.lifty.io/legal/terms-of-service.', '\n\n', 'This', ' ', 'operation', ' ', 'is', ' ', 'gasless', ' ', 'and', ' ', 'will', ' ', 'not', ' ', 'result', ' ', 'in', ' ', 'any', ' ', 'blockchain', ' ', 'transactions.', '\n\n', 'Wallet', ' ', 'address:', '  ', '_address_', '\n\n', 'Date:', ' ', '5/22/2023,', ' ', '_nonce_', ' ', 'AM' ],
